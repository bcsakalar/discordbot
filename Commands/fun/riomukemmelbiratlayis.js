...
module.exports = {
    ...
    .setName('riomükemmelbiratlayıs')
    .setDescription('rio mükemmel bir atlayış'),
    ...
    async execute(interaction) {
        ...
        await interaction.reply({content: 'https://kick.com/aynirio/clips/clip_01J73VQF34PQ4JTANA83FBC7J1'});
    } catch (error) {
